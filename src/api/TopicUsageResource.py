...
class TopicUsageResource(Resource):
    ...
    def get(topic_id):
        ...
        try:
            start_date, end_date = TopicUsageResource._check_query_params(request.args)
    ...
    def _check_query_params(query_params):
        ...
        start = TopicUsageResource._parse_raw(raw_start, 'start_date')
        raw_end = query_params.get('end_date', None)
        end = TopicUsageResource._parse_raw(raw_end, 'end_date', nullable=True)
        return start, end
